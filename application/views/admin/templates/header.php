...
<head>
    ...
    <meta name="keywords"
        content="Yayasan UCB, Yayasan Citra Bina Insan Mandiri Kupang, UCB, UCB, Universitas Citra Bangsa, Manajemen Kepegawaian" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta charset="utf-8" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="YAYASAN UCB - KUPANG, UCB, UCB, MANAJEMEN KEPEGAWAIAN" />
    <!-- <meta property="og:url" content="https://keenthemes.com/metronic" /> -->
    <meta property="og:site_name" content="Kepegawaian | UCB" />
    <link rel="canonical" href="https://preview.keenthemes.com/metronic8" />
    <link rel="shortcut icon" href="<?=base_url()?>assets/templates/media/logos/logo-ucb-ok.png" />
    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
    <!--end::Fonts-->
    <!--begin::Page Vendor Stylesheets(used by this page)-->
    <link href="<?=base_url()?>assets/templates/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
                ...
                <div class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper"
                    ...
                    <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold"
                        ...
                        <div class="menu-item py-2">
                            <a class="menu-link <?=$this->uri->segment(1) == 'home'?'active':'';?> menu-center"
                                href="<?=base_url('home')?>" data-bs-trigger="hover" data-bs-dismiss="click"
                    ...
                    <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold"
                        id="#kt_aside_menu" data-kt-menu="true">
                        <div class="menu-item py-2">
                            <a class="menu-link <?=$this->uri->segment(1) == 'krs'?'active':'';?> menu-center"
                                href="<?=base_url('krs')?>" data-bs-trigger="hover" data-bs-dismiss="click"
                                data-bs-placement="right">
                                <span class="menu-icon me-0">
                                    <i class="bi bi-table fs-2"></i>
                                </span>
                                <span class="menu-title text-center">Pengisian KRS</span>
                            </a>
                        </div>
                    </div>
                    <!--end::Menu-->
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                        ...
                        <div class="d-flex align-items-stretch flex-shrink-0">
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    <div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px"
                                        ...
                                        <span id="jumlah_notif" class="badge fs-5 ms-n4 text-danger">0</span>
                                        <audio hidden controls id="audioplay">
                                            <source
                                                src="<?=base_url()?>assets/templates/media/sounds/mixkit-confirmation-tone-2867.wav"
                                                type="audio/wav">
                                            <source
                                                src="<?=base_url()?>assets/templates/media/sounds/mixkit-confirmation-tone-2867.mp3"
                                                type="audio/mp3">
                            ...
                            background-image: url('<?=base_url()?>assets/templates/media/misc/pattern-1.jpg');
                          ">
                                            <!--begin::Title-->
                                                ...
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <div class="text-center px-4">
                                                        <img class="mw-100 mh-200px" alt="image"
                                                            src="<?=base_url()?>assets/templates/media/illustrations/sketchy-1/1.png" />
                                                    </div>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Wrapper-->
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                        data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                        data-kt-menu-placement="bottom-end">
                                        <img src="<?=base_url()?>assets/templates/media/avatars/150-26.jpg"
                                            alt="image" />
                                    </div>
                                    <!--begin::Menu-->
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5">
                                                        ...
                                                        <span
                                                            class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">o</span>
                                                    </div>
                                                </div>
                                                <!--end::Username-->
                                            </div>
