...
<div class="d-flex flex-column flex-root">
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
        style="background-image: url(<?=base_url();?>assets/templates/media/illustrations/sketchy-1/14.png">
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            <a href="<?=base_url();?><?=base_url();?>demo6/dist/index.html" class="mb-6 text-center">
                <!-- <img alt="Logo" src="<?=base_url();?>assets/templates/media/logos/logo-UCB.png" class="h-90px" /> -->
                <!-- <h1>UCB</h1> -->
            </a>
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                <form class="form w-100" novalidate="novalidate" method="post" id="kt_sign_in_form"
                    ...
                    <div class="text-center mb-10">
                        <h1 class="text-dark mb-3">INPUT KRS</h1>
